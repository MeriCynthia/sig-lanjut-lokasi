      ...
      <div class="card-body pt-0">
        <form action="<?= BASEURL ?>/toko/update/<?= $data['toko']['id'] ?>" method="post" enctype="multipart/form-data" class="needs-validation"
          ...
          <div class="form-group row gap-2 d-flex justify-cotent-around mb-3">
            <input type="double" id="lat" name="lat" class="form-control form-control-sm w-25 w-md-50 mx-3" readonly value="<?= $data['toko']['lat'] ?>">
            <input type="double" id="lng" name="lng" class="form-control form-control-sm w-25 w-md-50" readonly value="<?= $data['toko']['lng'] ?>">
          ...
          <div class="form-group my-2">
            ...
            <input type="text" id="name" class="form-control" name="name" maxlength="30" required value="<?= $data['toko']['name'] ?>">
            <div class="invalid-feedback">
          ...
          <div class="form-group mb-2">
            ...
            <input type="text" id="alamat" class="form-control" name="alamat" maxlength="50" required value="<?= $data['toko']['alamat'] ?>">
            <div class="invalid-feedback">
